					...
					appointments: [
						{
							...
							services: [
								{ id: "a", name: "Haircut", specializationId: "1", duration: 45 },
							],
							status: "pending",
						},
						{
							...
							services: [
								{ id: "b", name: "Beard Trim", specializationId: "2", duration: 30 },
							],
							status: "pending",
						},
						{
						...
						},
						{
							...
							services: [
								{ id: "f", name: "Shave", specializationId: "2", duration: 30 },
							],
							status: "pending",
						},
					],
					totalAppointments: 6,
					requiredSpecializationIds: ["1", "2"],
