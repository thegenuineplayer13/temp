...
import { CalendarNowView } from "../components/calendar/calendar-now-view";
...
export default function CalendarViewer() {
   ...
   const showStats = viewMode !== "now";
   const showNavigation = viewMode !== "now";
               ...
               <div className="flex flex-col gap-3 md:gap-4">
                  ...
                  <div className={cn("flex gap-2", isMobile ? "flex-col items-center justify-center" : "justify-between")}>
                     {showNavigation ? (
                        ...
                        <div className={cn("flex items-center justify-center", isMobile ? "w-full" : "")}>
                           <h2 className="font-semibold text-lg md:text-xl">{getDisplayTitle()}</h2>
                        </div>
                     )}
                     ...
                     <div className={cn("flex", isMobile ? "w-full justify-between items-center" : "items-center gap-2")}>
                        ...
                        <Tabs value={viewMode} onValueChange={(v) => setViewMode(v as any)}>
                           <TabsList>
                              <TabsTrigger value="now" className={isMobile ? "text-xs px-2.5" : ""}>
                                 Now
                              </TabsTrigger>
