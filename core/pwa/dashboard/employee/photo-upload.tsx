      ...
      <Dialog open={open} onOpenChange={handleClose}>
         <DialogContent className="sm:max-w-lg">
            <DialogHeader>
               ...
               <DialogDescription>
                  Capture photos to document the job completion. These are valuable for client records and quality assurance.
               </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4 py-4">
               ...
               {(beforePhoto || afterPhoto) && (
                  <div className="flex items-center gap-2 p-3 bg-green-500/5 border border-green-500/20 rounded-lg">
                     <ImageIcon className="h-4 w-4 text-green-600 dark:text-green-500" />
                     <p className="text-sm text-green-700 dark:text-green-400">
                        {beforePhoto && afterPhoto ? "Both photos captured" : "One photo captured"}
                     </p>
                  </div>
               )}
            </div>
